...
class App:
    def __init__(self, master):
        ...
        self.name_label=tk.Label(input_frame, text="Nosaukums", font=("Helvetica", 10))
        self.name_label.grid(row=1, column=0, padx=5, pady=5)
        self.name_entry = tk.Entry(input_frame)
        self.name_entry.grid(row=1, column=1, padx=20)

        self.quantity_label=tk.Label(input_frame, text ="Daudzums", font=("Helvetica", 10))
        ...
        self.price_label=tk.Label(input_frame, text="Cena", font=("Helvetica", 10))
        ...
        self.add_button=tk.Button(master, text="Pievienot grozam", command=self.add_to_cart, font=("Helvetica", 10))
        ...
        self.clear_button = tk.Button(master, text="Dzēst grozu", command=self.clear_cart, font=("Helvetica", 10))
